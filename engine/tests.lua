...
--     local tk = require "engine.libraries.girvel.toolkit"
...
--     local module = require "engine.libraries.girvel.module"

--     describe("require all function", function()
--       it("should import all modules from directory", function()
--         local parent = module.require_all("engine.test_samples.sample1")
...
--         local parent = module.require_all("engine.test_samples.sample2")

--         assert.is_true(parent.child.sample)
--       end)

--       it("should recursively use _representation.lua if possible", function()
--         local parent = module.require_all("engine.test_samples.sample3")
...
--     local decorator = require("engine.libraries.girvel.decorator")
--     it("should decorate functions", function()
--       local dummy = decorator(function(self, f, a, b) return a + b end)
...
--   local action = require("engine.aspects.action")

--   describe("", function()
--     it("should realize eDSL", function()
--       local result = action[[die | alive -> dead]](1)
