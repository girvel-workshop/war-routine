...
describe("my own lua framework", function()
  describe("endswith function", function()
    it("should check postfixes", function()
      assert.is_true(("hello world"):ends_with("orld"))
      assert.is_false(("hi world"):ends_with("dd"))
    end)
  end)

  describe("starts_with function", function()
    it("should check prefixes", function()
      assert.is_true(("hello world"):starts_with("hello w"))
      assert.is_false(("hi world"):starts_with("dd"))
    end)
  end)
